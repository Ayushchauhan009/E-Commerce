  ...
  return (
    <div className="pt-6 px-6 md:px-16 pb-16 lg:px-28 font-nunito">
      ...
      <div className="grid grid-cols-2  lg:grid-cols-3">
        <div className="bg-white gap-6 lg:gap-14 border shadow-xl rounded-[12px] p-6 m-2 flex flex-col items-center jutify-evenly">
          <img src={scout1} alt="" />
          <p className="font-semibold text-center text-[18px] lg:text-[20px]">
