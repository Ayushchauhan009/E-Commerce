    ...
    <div className=" px-6 md:px-16 pb-10 lg:px-28 font-nunito">
      ...
      <div className="flex flex-col md:flex-row justify-start">
        ...
        <div className="w-full lg:w-[50%]">
          <p className="text-base md:text-lg">
            We create brand affinity and loyalty through distinctive branding.
            Leveraging data and storytelling, we drive conversions with
            compelling messages and identities.
          </p>
        </div>
      </div>
      <div className="my-10 w-full h-0.5 bg-gradient-to-r from-purple-400 via-blue-500 to-purple-600"></div>
